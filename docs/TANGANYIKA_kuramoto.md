...
1. **Contexte de Stress (Augmentation de la Sensibilité) :** Le pays venait d'obtenir son indépendance. Le stress social agit comme un amplificateur de gain sur les oscillateurs, rendant les cerveaux instables et prêts à synchroniser.
2. **Système Fermé (Feedback Loop) :** Dans une école ou un village isolé, le signal  rebondit sans s'échapper (chambre d'écho).
3. **Hystérie de Masse (MPI) :** Scientifiquement classé comme *Mass Psychogenic Illness*. Le rire n'était pas de la joie, mais une décharge de tension synchronisée. Le système nerveux cherchait l'homéostasie par une oscillation violente.
